...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        self.qvalues = util.Counter()  # Initialize Q-values as a Counter (dictionary with default 0)
    ...
    def getValue(self, state):
        ...
        # look for best value while breaking ties randomly
        max_value = float('-inf')
        best_actions = []
        ...
        for action in legalActions:
            ...
            if q_value > max_value:
                max_value = q_value
                best_actions = [q_value]
            elif q_value == max_value:
                best_actions.append(q_value)
